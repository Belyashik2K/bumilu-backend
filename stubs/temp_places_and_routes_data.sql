WITH lang_list AS (SELECT *
     ...
     place_seed AS (SELECT *
                    FROM (VALUES ('hermitage', 'museum', 30.3158:: double precision, 59.9398:: double precision,
                                 ...
                                 ('isaac', 'landmark', 30.3061:: double precision, 59.9343:: double precision,
                                 ...
                                 ('kazan', 'landmark', 30.3231:: double precision, 59.9345:: double precision,
                                 ...
                                 ('savior', 'landmark', 30.3287:: double precision, 59.9408:: double precision,
                                 ...
                                 ('summer_garden', 'park', 30.3324:: double precision, 59.9451:: double precision,
                                 ...
                                 ('new_holland', 'park', 30.2739:: double precision, 59.9289:: double precision,
                                 ...
                                 ('sevkabel', 'viewpoint', 30.2255:: double precision, 59.9249:: double precision,
                                 ...
                                 ('dvorcovy_bridge', 'viewpoint', 30.3082:: double precision,
                                  59.9475:: double precision, 'Дворцовый мост', 'Palace Bridge', '宫殿桥',
                                 ...
                                 ('bolshe_coffee', 'cafe', 30.3186:: double precision, 59.9449:: double precision,
                                 ...
                                 ('skuratov', 'cafe', 30.3248:: double precision, 59.9328:: double precision,
