...
class GetAdminPlaceCategoryTranslationQueryHandler(
    ...
    def __init__(
        ...
        self.place_category_translation_reader = place_category_translation_reader

    async def handle(
        self, query: GetAdminPlaceCategoryTranslationQuery
    ) -> PlaceCategoryTranslationReadModel:
        translation = await self.place_category_translation_reader.get_by_category_id_and_language_code(
